...
def detail_view(request, sku=None, model_cls=None, serializer_cls=None):
    '''
    ## API Endpoints for 'GET', 'POST', 'PUT', 'DELETE' for the Item and 'POST' for Category
    
    ## The sku needs to be passed in GET, PUT and DELETE Requests for the Item

    ## The model_cls and the serializer_cls is customized in urls.py based on the request(Item or Category)
    '''
